...
document.querySelectorAll("hr.image").forEach(elm => {
...
document.querySelector(".six").style.color = "balck";
...
allBoxes.forEach((elm, i) => {
  if (i % 2 === 0) {
    elm.style.background = "aliceblue";
  }
});
